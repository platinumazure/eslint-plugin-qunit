...
const ALL_MODULE_HOOK_IDENTIFIERS = OLD_MODULE_HOOK_IDENTIFIERS.concat(NEW_MODULE_HOOK_IDENTIFIERS);
...
exports.getAssertContextNameForTest = function (argumentsNodes) {
    const functionExpr = argumentsNodes.filter(function (argNode) {
