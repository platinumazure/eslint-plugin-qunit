...
const ALL_MODULE_HOOK_IDENTIFIERS = new Set([...OLD_MODULE_HOOK_IDENTIFIERS, ...NEW_MODULE_HOOK_IDENTIFIERS]);
...
exports.isTodo = function (calleeNode) {
    return isQUnitMethod(calleeNode, "todo");
};
