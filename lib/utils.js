...
exports.isAssertion = function (calleeNode, assertVar) {
    ...
    if (calleeNode.type === "MemberExpression") {
        return calleeNode.object &&
            ...
            calleeNode.property &&
            Object.hasOwnProperty.call(ASSERTION_ARITY, calleeNode.property.name);
...
exports.getAllowedArities = function (calleeNode, assertVar) {
    ...
    /* istanbul ignore else: correctly returns empty array */
    if (calleeNode.type === "MemberExpression") {
        result = calleeNode.object &&
            calleeNode.object.name === assertVar &&
            calleeNode.property &&
            ASSERTION_ARITY[calleeNode.property.name];
    } else if (calleeNode.type === "Identifier") {
        result = ASSERTION_ARITY[calleeNode.name];
    }

    return result || /* istanbul ignore next */ [];
};
