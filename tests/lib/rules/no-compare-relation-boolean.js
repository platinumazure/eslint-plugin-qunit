...
ruleTester.run("no-compare-relation-boolean", rule, {
    ...
    invalid: [
        ...
        {
            code: testUtils.wrapInTest("assert.equal(a === b, true, 'message');"), // With message
            output: testUtils.wrapInTest("assert.ok(a === b, 'message');")
        },
        {
            code: testUtils.wrapInTest("assert.equal(a === b, false, 'message');"), // With message
        ...
        {
            code: testUtils.wrapInTest("assert.notStrictEqual(a === b, false);"),
            output: testUtils.wrapInTest("assert.ok(a === b);")
        },
        ...
        {
            code: testUtils.wrapInTest("assert.equal(true, a === b, 'message');"), // With message
            output: testUtils.wrapInTest("assert.ok(a === b, 'message');")
        },
        {
            code: testUtils.wrapInTest("assert.equal(false, a === b, 'message');"), // With message
            output: testUtils.wrapInTest("assert.notOk(a === b, 'message');")
        },
        ...
        {
            code: testUtils.wrapInTest("assert.notStrictEqual(false, a === b);"),
            output: testUtils.wrapInTest("assert.ok(a === b);")
        },
